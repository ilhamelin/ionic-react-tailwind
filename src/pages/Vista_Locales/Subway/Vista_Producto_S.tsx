...
import Portada_L from "../../../img/Subway/Portada_Oferta.png";
    ...
    <>
      ...
      <IonContent fullscreen={true}>
        <div className="flex flex-col">
          ...
          <div className="flex  x:mt-5  x:gap-x-10  l:mt-4 l:gap-x-5 g:mt-5 g:gap-x-3 items-center justify-center mx-2">
            <div>
              <label className=" relative inline-flex cursor-pointer select-none items-center justify-center rounded-2xl bg-white px-1  bg-Gris_muy_claro">
                ...
                />
                <span
                  className={`flex items-center x:space-x-[6px] x:px-[18px] x:text-sm l:px-[14px] l:space-x-[3px] l:text-sm g:px-[18px] g:text-[11px] g:line py-1 my-1 rounded-2xl t font-font-family-light ${
            ...
            <div className="flex items-center bg-Gris_muy_claro x:px-[9px] x:py-[9px]  rounded-2xl space-x-2 l:px-[7px] l:py-[7px] g:px-[8px] g:py-[5px]">
              <div>
                <FaUserPlus />
              </div>
              <div className="font-font-family-light font-normal x:text-[14px] l:text-[14px] l:leading-5 g:text-[10px] g:leading-4">
                pedido grupal
              </div>
            </div>
          </div>
