...
import { getProductKFCFromFirestore } from "../../../firebase/firebase-functions";
import { IonToast } from "@ionic/react";

import { FaCircle } from "react-icons/fa";

const ProductosListKFC = ({ idProducto }: { idProducto: string }) => {
  ...
  useEffect(() => {
    const fetchProductoData = async () => {
      try {
        const data = await getProductKFCFromFirestore(idProducto);
        setProductData(data);
      } catch (error) {
...
export default ProductosListKFC;
