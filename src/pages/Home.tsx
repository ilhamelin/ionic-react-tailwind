  ...
  return (
    <IonPage>
      <IonHeader class="ion-no-border">
        <IonToolbar class="flex flex-row  l:mb-2 ">
          <div className="flex ">
            ...
            <div className="flex flex-auto items-center justify-end">
              <nav className="flex items-center gap-x-4">
                <button className="relative bg-Gris_muy_claro py-2 px-2 rounded-full ">
                  ...
                  <span className="absolute -top-1 -right-1 bg-Cian_oscuro py-1 px-[6px] rounded-full box-content text-[9px] font-bold text-white">
                    2
                  </span>
                </button>
      ...
      <IonContent>
        ...
        <div className=" mt-3 ml-2 md:mt-5 text-center">
          <Swiper
            width={400}
          ...
          <div className="md:flex md:ml-2">
            <div className="flex justify-center">
              ...
              <div className="flex absolute items-center xm:gap-x-[65px] ">
                ...
                <div className="ml-[132px] l:ml-[80px] x:ml-[126px] md:ml-[126px] g:ml-[30px] text-end">
            ...
            <div className=" mx-2 my-2">
              <div className="">
                <div className="flex text-[19px]  g:text-[18px] font-font-family-light font-medium leading-6 gap-x-[296px] l:gap-x-[245px] x:gap-x-[290px] md:gap-x-[150px] xm:gap-x-[350px] g:gap-x-[190px]">
                  Sabor X2
          ...
          <div className="md:flex md:flex-row-reverse mb-3 mt-3 mb:ml-2 ">
            <div className="flex justify-center">
              <img
                ...
                src={oferta2}
              />
              <div className="flex absolute items-center gap-x-[260px] l:gap-x-[210px] x:gap-x-[260px] md:gap-x-[260px] xm:gap-x-[320px]">
                <div className="flex bg-Cian_oscuro mt-1 ml-[2px] rounded-lg px-1 text-[12px] items-center text-white">
                  <IoTrophyOutline className="mx-[2px] " />
                  Ahorros exclusivos
                </div>
            ...
            >
              <SwiperSlide>
                ...
                <div className="mx-2 my-2 l:mx-0 xm:mx-2.5 g:mx-0">
                  <div className="flex gap-x-[150px] l:gap-x-[118px] x:gap-x-[150px] xm:gap-x-[190px] g:gap-x-[90px]">
              ...
              <SwiperSlide>
                ...
                <div className="mx-2 my-2 l:mx-0 xm:ml-2 g:mx-0">
                  <div className="flex text-[15px] font-semibold gap-x-[130px] l:gap-x-[125px] x:gap-x-[145px] xm:gap-x-[180px] g:gap-x-[90px]">
                    Burger King
                    <div className="bg-Gris_muy_claro py-1 px-1 rounded-full text-[13px] font-semibold">
                      4.3
                    </div>
